...
install_php(){
    ...
    for package in  bcmath bz2 cli common cropper curl fpm gd getid3 geoip php-gettext imagick imap inotify intl json mbstring mysql oauth opcache pclzip pear phpmailer phpseclib mcrypt snoopy soap sqlite3 recode tcpdf tidy xml xmlrpc yaml zip zstd
    do
